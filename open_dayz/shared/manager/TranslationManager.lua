...
-- *  FILE:        	shared/manager/TranslationManager.lua
-- *  PURPOSE:     	Class to manage translations
-- *
-- ****************************************************************************
TranslationManager = inherit(Exported)
inherit(Singleton, TranslationManager)
...
function TranslationManager:loadTranslation(locale, poFile)
	checkArgs("TranslationManager:loadTranslation", "string")
...
function TranslationManager:translate(message, locale)
	checkArgs("TranslationManager:translate", "string")
